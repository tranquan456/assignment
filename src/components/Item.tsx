    ...
    return <div className="h-72 rounded-lg bg-white mb-6  border-2 border-black-100 flex">
            ...
            <div className="py-16 sm:px-6  ">
                ...
                <div className="mt-7 flex">
                    ...
                    <p className=" tx-lg py-1 text-gray-700 font-medium ">{props.adress1}</p>
                </div>
                ...
                <div className="flex mt-2" >
                    ...
                    <p className=" tx-lg py-1 text-gray-600 font-medium">{props.adress2}</p>
                </div>
            </div>

            <div className="py-16 sm:px-6 ">
                <div className="ml-56">
                    <div className="text-xl font-semibold text-gray-600 text-[#2474E5]">
                    <h2  >{props.price}</h2>
                    </div>
                <div className="inline-flex gap-2 rounded bg-red-100 p-1 text-red-600 ml-7">
